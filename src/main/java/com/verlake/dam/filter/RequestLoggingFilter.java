...
public class RequestLoggingFilter implements Filter {
    ...
    private void logRequest(ContentCachingRequestWrapper request) {
        ...
        boolean detailedLoggingEnabled = Constants.getTechnicalPropertyAsBoolean(Constants.LOGGING_DETAILED_REQUEST_RESPONSE_ENABLED, false);
    ...
    private void logResponse(ContentCachingResponseWrapper response, long duration) {
        ...
        if (detailedLoggingEnabled) {
            logDetailedResponseInfo(response);
        }
    ...
    private void logDetailedResponseInfo(ContentCachingResponseWrapper response) {
    ...
    private void logResponseBody(ContentCachingResponseWrapper response) {
        ...
        if (content.length > 0) {
            logResponseBodyContent(content, response.getCharacterEncoding());
        } else {
    ...
    private void logResponseBodyContent(byte[] content, String encoding) {
        try {
