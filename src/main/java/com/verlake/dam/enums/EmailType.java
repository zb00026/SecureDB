...
public enum EmailType {
    ...
    ACCESSOR_ASSET_REQUEST_NOTIFY,
    ACCESSOR_RELINQUISH_ASSET_NOTIFY,
    ...
    public static EmailType fromString(String value) {
        return switch (value) {
            ...
            case "ACCESSOR_ASSET_REQUEST_NOTIFY" -> ACCESSOR_ASSET_REQUEST_NOTIFY;
            case "ACCESSOR_RELINQUISH_ASSET_NOTIFY" -> ACCESSOR_RELINQUISH_ASSET_NOTIFY;
